...
public class FAFItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        handheldItem(FAFItems.OBSIDIAN_KNIFE);

    }

    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = ForgedAndFound.MOD_ID;
        ...
        if(itemDeferredItem.get() instanceof ArmorItem armorItem) {
            trimMaterials.forEach((trimMaterial, value) -> {
                ...
                this.withExistingParent(itemDeferredItem.getId().getPath(),
                        ...
                        .texture("layer0", FAFUtility.ID("item/" + itemDeferredItem.getId().getPath()));
            });
        }
    }
    ...
    private ItemModelBuilder handheldItem(DeferredItem<?> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                FAFUtility.ID("item/" + item.getId().getPath()));
    }
}
